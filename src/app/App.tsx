...
export default function App() {
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-screen bg-[#11141A] flex items-center justify-center p-4 font-sans">
        <div className="max-w-lg w-full bg-[#0D0D0D] border-2 border-[#C5A880]/40 rounded-3xl p-8 sm:p-10 shadow-2xl text-white relative overflow-hidden">
          <div className="text-center mb-8">
            ...
            />
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#C5A880]/15 border border-[#C5A880]/40 rounded-full mb-4 text-xs font-semibold text-[#C5A880]">
          ...
          <form onSubmit={handlePasscodeSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3.5 bg-[#11141A] border border-slate-700 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:border-[#C5A880] focus:ring-2 focus:ring-[#C5A880]/20 transition-all text-base"
                autoFocus
              />
            ...
            <button
              type="submit"
              className="w-full py-4 bg-[#C5A880] hover:bg-[#B89758] text-[#11141A] font-bold rounded-xl shadow-lg transition-all transform hover:-translate-y-0.5 cursor-pointer text-base uppercase tracking-wider"
            >
              Access Website
            </button>
          </form>
          ...
          <div className="mt-8 pt-6 border-t border-slate-800 text-center text-xs text-slate-400 space-y-1">
            ...
            <p>Direct Phone <a href="tel:8182322760" className="text-[#C5A880] hover:underline font-bold">(818) 232-2760</a></p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFA] text-[#11141A] font-sans selection:bg-[#C5A880] selection:text-[#11141A]">
      <Header 
...
// Header Component (60-30-10: Crisp Off-White Base, Deep Charcoal Structure, Golden Beige Accent)
function Header({ currentPage, setCurrentPage, mobileMenuOpen, setMobileMenuOpen, openConsultModal }: any) {
  ...
  return (
    <>
      {/* Top Utility Bar - Deep Charcoal Background (30%) with Golden Beige (10%) Contact Info */}
      <div className="bg-[#11141A] text-slate-300 border-b border-[#C5A880]/30 text-xs py-2.5 px-4 sm:px-8 hidden sm:block z-50 relative">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-6">
            <span className="font-semibold text-[#C5A880] tracking-wider uppercase">So Cal Legal Group, Inc.</span>
            <span>Mailing Address: 1812 West Burbank Blvd., #36 Burbank CA 91506</span>
          </div>
          <div className="flex items-center gap-6 font-medium">
            <a href="mailto:info@sclglawyers.com" className="hover:text-[#C5A880] transition-colors">info@sclglawyers.com</a>
            <a href="tel:8182322760" className="text-[#C5A880] font-bold hover:underline flex items-center gap-1.5">
      ...
      {/* Main Luxury Header - Crisp Off-White Base (60%) with Deep Charcoal Menu Text & Golden Beige CTA */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center min-h-[96px] sm:min-h-[108px]">
            ...
            <div className="flex items-center gap-8 xl:gap-14">
              ...
              {/* Desktop Navigation Links (Deep Charcoal Text, Golden Beige Active Indicator) */}
                  ...
                  item.submenu ? (
                    <div key={item.id} className="relative group">
                      <button className="flex items-center space-x-1.5 py-3 text-[#11141A] hover:text-[#B89758] font-semibold transition-colors cursor-pointer text-base uppercase tracking-wider">
                        ...
                        <ChevronDown className="w-4 h-4 transition-transform group-hover:rotate-180 text-[#C5A880]" />
                      </button>
                      <div className="absolute top-full left-0 w-60 bg-[#11141A] text-white border border-[#C5A880]/40 rounded-xl shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 py-3 overflow-hidden">
                        {item.submenu.map((subitem) => (
                          <button
                            key={subitem.id}
                            onClick={() => setCurrentPage(subitem.id)}
                            className="block w-full text-left px-5 py-3 text-sm text-slate-200 hover:bg-[#1C2029] hover:text-[#C5A880] transition-colors cursor-pointer font-medium"
                          >
                            {subitem.label}
                          </button>
                        ))}
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              {/* Golden Beige Accent Button (10% Prestige Accent) */}
              <button 
            ...
            <div className="flex items-center lg:hidden space-x-3">
              <a
                href="tel:8182322760"
                className="p-2.5 bg-[#11141A] text-[#C5A880] rounded-lg"
              >
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 z-40 lg:hidden bg-[#FFFFFF] pt-36 px-6 pb-12 overflow-y-auto">
          <nav className="flex flex-col space-y-5 max-w-md mx-auto">
            ...
            <a
              href="tel:8182322760"
              className="flex items-center justify-center gap-3 bg-[#11141A] text-[#C5A880] py-4 rounded-xl font-bold text-lg border border-[#C5A880]/50"
            >
            ...
            <button 
              ...
              className="bg-[#C5A880] hover:bg-[#B89758] text-[#11141A] font-bold py-4 rounded-xl text-lg uppercase tracking-wider shadow-lg">
...
function HomePage({ setCurrentPage, openConsultModal }: any) {
  return (
    <main className="pt-36 sm:pt-44 pb-20 lg:pb-0">
      {/* Hero Section - Deep Charcoal (30% Structure) Background with White Serif Typography & Golden Beige Accent */}
      <section className="relative bg-[#11141A] text-white py-20 lg:py-28 overflow-hidden border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#C5A880]/15 border border-[#C5A880]/30 rounded-full text-xs font-bold uppercase tracking-widest text-[#C5A880]">
                <Shield className="w-4 h-4 text-[#C5A880]" />
                <span>Southern California Legal Advocacy</span>
              </div>

              {/* White Serif Heading with Golden Beige Subtext Accent Line */}
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-serif font-bold text-white leading-tight tracking-tight">
                ...
                <span className="text-[#C5A880] italic">Trust, Integrity & Results</span>
              </h1>
              
              <p className="text-lg lg:text-xl text-slate-300 leading-relaxed font-sans border-l-4 border-[#C5A880] pl-6">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                {/* 10% Golden Beige Primary CTA Button (Dark text on top for WCAG AA compliance) */}
                <button 
                  onClick={openConsultModal}
                  className="bg-[#C5A880] hover:bg-[#B89758] text-[#11141A] px-8 py-4 rounded-xl text-base font-bold shadow-xl transition-all transform hover:-translate-y-0.5 cursor-pointer uppercase tracking-wider border border-[#B89758]">
                  Schedule Free Consultation
                </button>
                <a 
                  href="tel:8182322760"
                  className="bg-[#1C2029] hover:bg-[#252A36] text-white border border-slate-700 px-7 py-4 rounded-xl text-base font-bold transition-all flex items-center gap-3">
                  <Phone className="w-5 h-5 text-[#C5A880]" />
                  (818) 232-2760
                </a>
              </div>
            ...
            <div className="lg:col-span-5 flex justify-center">
              <div className="relative w-full max-w-md">
                <div className="relative bg-[#0D0D0D] border-2 border-[#C5A880]/30 rounded-3xl overflow-hidden shadow-2xl">
                  <img 
                    src={headshot2} 
                    alt="Arpi Sislyan, Esq. - Partner"
                    className="w-full h-auto object-cover" 
                  />
                  <div className="p-6 bg-[#11141A] text-white border-t border-[#C5A880]/40">
                    <h3 className="text-2xl font-bold font-serif text-white">Arpi Sislyan, Esq.</h3>
                    <p className="text-[#C5A880] text-sm font-semibold tracking-wide uppercase mt-1">Partner &bull; So Cal Legal Group, Inc.</p>
      ...
      {/* Practice Area Cards Section - Clean Off-White Base (60%) with Pure White Cards & Golden Beige Accent Borders */}
      ...
      {/* Main Principles Section - Off-White (60%) Background & Deep Charcoal (30%) Blocks */}
      <section className="py-24 bg-[#FAFAFA] border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          <div className="grid lg:grid-cols-2 gap-12 items-stretch">
            {/* Deep Charcoal Card */}
            <div className="bg-[#11141A] text-white p-10 rounded-3xl border border-[#C5A880]/30 shadow-xl flex flex-col justify-between">
              <div>
              ...
              <div className="mt-8 pt-6 border-t border-slate-800 flex items-center gap-3 text-[#C5A880] font-bold text-sm">
          ...
          {/* Contingency Fee Box - Off-White with Golden Beige Accent Border */}
      ...
      {/* Attorney Spotlight Section - Off-White (60%) Background */}
      <section className="py-24 bg-[#FFFFFF] border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="relative aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl border-2 border-[#11141A]">
              <img 
                src={headshot1} 
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-wrap items-center gap-4 pt-4">
                <button 
                  ...
                  className="bg-[#11141A] text-white border border-[#C5A880]/50 px-8 py-3.5 rounded-xl font-bold hover:bg-[#1C2029] transition-all shadow-md cursor-pointer uppercase text-sm tracking-wider"
                >
      ...
      {/* CTA Banner - Deep Charcoal Container (30%) with White Typography and Golden Beige Button (10%) */}
      <section className="py-20 bg-[#FAFAFA]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#11141A] text-white rounded-3xl p-10 sm:p-14 border border-[#C5A880]/40 shadow-2xl text-center space-y-8 relative overflow-hidden">
            
            <span className="inline-block text-xs font-bold uppercase tracking-widest text-[#C5A880] bg-[#C5A880]/15 border border-[#C5A880]/30 px-4 py-1.5 rounded-full">
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-4">
              ...
              <a 
                href="tel:8182322760" 
                className="bg-[#1C2029] hover:bg-[#252A36] text-white border border-slate-700 px-8 py-4 rounded-xl text-base font-bold flex items-center gap-3 transition-all">
                <Phone className="w-5 h-5 text-[#C5A880]" />
                Call (818) 232-2760
              </a>
            </div>
...
// Practice Area Card Component (Pure White Interior, Thin 1px Golden Beige Border)
  ...
  return (
    ...
    >
      <div>
        ...
        <div className="w-full h-40 bg-[#11141A] rounded-2xl border border-slate-800 mb-6 flex flex-col items-center justify-center p-4 text-center group-hover:border-[#C5A880]/50 transition-colors relative overflow-hidden">
          <Shield className="w-8 h-8 text-[#C5A880] mb-2 relative z-10" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-5 space-y-6">
              <div className="bg-[#FFFFFF] rounded-3xl overflow-hidden shadow-2xl border-2 border-[#11141A]">
                <img 
                  src={headshot2} 
                  alt="Arpi Sislyan, Esq." 
                  className="w-full h-auto object-cover"
              ...
              {/* Attorney Contact Details Container */}
              <div className="bg-[#11141A] text-white border border-[#C5A880]/40 rounded-3xl p-7 shadow-xl space-y-5">
                ...
                <div className="space-y-4 text-sm">
                  <div className="flex items-start gap-3">
                    <Users className="w-5 h-5 text-[#C5A880] flex-shrink-0 mt-1" />
                    <div>
                      ...
                      <span className="text-[#C5A880] text-xs block font-medium">Partner &bull; So Cal Legal Group, Inc.</span>
                    </div>
                  </div>

                  <div className="flex items-start gap-3">
                    <Phone className="w-5 h-5 text-[#C5A880] flex-shrink-0 mt-1" />
                    <div>
                      <span className="text-xs uppercase font-bold tracking-wider text-slate-400 block">Telephone</span>
                      <a href="tel:8182322760" className="font-bold text-white text-base hover:text-[#C5A880] transition-colors">(818) 232-2760</a>
                    </div>
                  </div>

                  <div className="flex items-start gap-3">
                    <Mail className="w-5 h-5 text-[#C5A880] flex-shrink-0 mt-1" />
                    <div>
                      <span className="text-xs uppercase font-bold tracking-wider text-slate-400 block">Email Address</span>
                      <a href="mailto:info@sclglawyers.com" className="font-bold text-[#C5A880] hover:underline block text-sm">info@sclglawyers.com</a>
                      <a href="mailto:arpi@sclglawyers.com" className="font-semibold text-slate-300 hover:underline text-xs">arpi@sclglawyers.com</a>
                    </div>
                  </div>

                  <div className="flex items-start gap-3">
                    <MapPin className="w-5 h-5 text-[#C5A880] flex-shrink-0 mt-1" />
                    <div>
                ...
                <button
                  onClick={openConsultModal}
                  className="w-full mt-4 bg-[#C5A880] hover:bg-[#B89758] text-[#11141A] py-3.5 rounded-xl font-bold text-sm uppercase tracking-wider shadow-lg transition-colors cursor-pointer"
                >
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="mt-12 pt-8 border-t border-slate-200">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-[#11141A] text-white p-6 rounded-2xl border border-[#C5A880]/40 shadow-md">
                    <Shield className="w-8 h-8 text-[#C5A880] mb-3" />
...
function EmploymentLawPage({ openConsultModal }: any) {
  return (
    <main className="pt-36 sm:pt-44 pb-20 lg:pb-0">
      <section className="py-16 bg-[#11141A] text-white border-b-2 border-[#C5A880]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <span className="text-xs font-bold text-[#C5A880] uppercase tracking-widest">Practice Area Overview</span>
      ...
      <section className="py-20 bg-[#FAFAFA]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="w-full h-72 sm:h-96 bg-[#11141A] rounded-3xl border border-[#C5A880]/30 shadow-2xl flex flex-col items-center justify-center p-8 text-center relative overflow-hidden">
            <Users className="w-16 h-16 text-[#C5A880] mb-4 relative z-10" />
            <h3 className="text-2xl font-serif font-bold text-white relative z-10 mb-2">
              Employment Law Practice Area Photo
            </h3>
            <p className="text-[#C5A880] text-sm font-semibold tracking-wider uppercase relative z-10">
    ...
    <main className="pt-36 sm:pt-44 pb-20 lg:pb-0">
      ...
      <section className="py-20 bg-[#FAFAFA]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          {/* Designated Practice Area Photo Slot */}
          <div className="w-full h-72 sm:h-96 bg-[#11141A] rounded-3xl border border-[#C5A880]/30 shadow-2xl flex flex-col items-center justify-center p-8 text-center relative overflow-hidden">
            <Shield className="w-16 h-16 text-[#C5A880] mb-4 relative z-10" />
            <h3 className="text-2xl font-serif font-bold text-white relative z-10 mb-2">
    ...
    <main className="pt-36 sm:pt-44 pb-20 lg:pb-0">
      ...
      <section className="py-20 bg-[#FAFAFA]">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          {/* Designated Practice Area Photo Slot */}
          <div className="w-full h-72 sm:h-96 bg-[#11141A] rounded-3xl border border-[#C5A880]/30 shadow-2xl flex flex-col items-center justify-center p-8 text-center relative overflow-hidden">
            <Scale className="w-16 h-16 text-[#C5A880] mb-4 relative z-10" />
            <h3 className="text-2xl font-serif font-bold text-white relative z-10 mb-2">
...
function TestimonialsPage({ openConsultModal }: any) {
  ...
  return (
    <main className="pt-36 sm:pt-44 pb-20 lg:pb-0">
      <section className="py-16 bg-[#11141A] text-white text-center border-b-2 border-[#C5A880]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <span className="text-xs font-bold text-[#C5A880] uppercase tracking-widest">Client Feedback & Results</span>
          <h1 className="text-4xl lg:text-5xl font-serif font-bold mt-2">
            Client Testimonials
          </h1>
        </div>
...
function ContactPage() {
  ...
  return (
    <main className="pt-36 sm:pt-44 pb-20 lg:pb-0">
      <section className="py-16 bg-[#11141A] text-white border-b-2 border-[#C5A880]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <span className="text-xs font-bold text-[#C5A880] uppercase tracking-widest">Get In Touch</span>
          <h1 className="text-4xl lg:text-5xl font-serif font-bold mt-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6 bg-[#11141A] text-white p-8 rounded-3xl border border-[#C5A880]/40 shadow-xl">
                <div className="flex items-start space-x-4 border-b border-slate-800 pb-5">
                  <Users className="w-6 h-6 text-[#C5A880] flex-shrink-0 mt-1" />
                  <div>
                    ...
                    <p className="text-[#C5A880] text-xs">Partner &bull; So Cal Legal Group, Inc.</p>
                  </div>
                </div>

                <div className="flex items-start space-x-4 border-b border-slate-800 pb-5">
                  <Phone className="w-6 h-6 text-[#C5A880] flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold text-slate-400 text-xs uppercase tracking-wider">Telephone</h3>
                    <a href="tel:8182322760" className="text-xl font-bold text-[#C5A880] hover:underline">
                      (818) 232-2760
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4 border-b border-slate-800 pb-5">
                  <Mail className="w-6 h-6 text-[#C5A880] flex-shrink-0 mt-1" />
                  <div>
                    <h3 className="font-semibold text-slate-400 text-xs uppercase tracking-wider">Email Addresses</h3>
                    <a href="mailto:info@sclglawyers.com" className="text-base font-bold text-[#C5A880] hover:underline block">
                ...
                <div className="flex items-start space-x-4">
                  <MapPin className="w-6 h-6 text-[#C5A880] flex-shrink-0 mt-1" />
                  <div>
            ...
            <div>
              ...
              <form className="space-y-6 bg-[#FFFFFF] p-8 rounded-3xl border-2 border-slate-200 shadow-xl" onSubmit={handleFormSubmit}>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input 
                      ...
                      name="firstName"
                      required
                      className="w-full px-4 py-3 bg-[#FAFAFA] border border-slate-300 rounded-xl focus:outline-none focus:border-[#C5A880]"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <select name="practiceArea" className="w-full px-4 py-3 bg-[#FAFAFA] border border-slate-300 rounded-xl focus:outline-none focus:border-[#C5A880]">
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    name="message"
                    required
                    className="w-full px-4 py-3 bg-[#FAFAFA] border border-slate-300 rounded-xl focus:outline-none focus:border-[#C5A880] resize-none"
                  ></textarea>
                </div>
      ...
      <div className="bg-[#0D0D0D] border-2 border-[#C5A880]/50 rounded-3xl max-w-xl w-full p-8 text-white relative shadow-2xl overflow-hidden max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleModalSubmit} className="space-y-4">
          ...
          <button 
            type="submit" 
            disabled={isSubmitting}
            className="w-full py-3.5 bg-[#C5A880] hover:bg-[#B89758] text-[#11141A] font-bold rounded-xl shadow-lg transition-all uppercase tracking-wider cursor-pointer text-sm"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16 pb-12 border-b border-slate-800">
          ...
          <div className="bg-[#11141A] p-6 rounded-2xl border border-[#C5A880]/40 space-y-4">
            ...
            <button 
              onClick={openConsultModal}
              className="w-full bg-[#C5A880] hover:bg-[#B89758] text-[#11141A] py-3 rounded-xl font-bold text-xs uppercase tracking-wider shadow-lg transition-colors cursor-pointer">
